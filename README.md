...
### 3. get_book_genre
- **test_get_book_genre_returns_correct_genre** — проверяет, что метод возвращает установленный жанр (`Фантастика`) для книги `Метро 2033`. *(добавлено после правок ревьюера)*
...
### 5. get_books_genre
- **test_get_books_genre_returns_full_dict** — проверяет, что метод возвращает полный словарь с книгами и их жанрами. *(добавлено после правок ревьюера)*
